...
/** Variante activa del TieredMenu en Interaction (popover). */
export type TieredMenuCatalogVariant = 'basic' | 'popup';

export type TieredMenuCatalogButtonStyle = 'button-default' | 'menu-button';

export interface TieredMenuCatalogInteractionState {
  variant: TieredMenuCatalogVariant;
  buttonStyle: TieredMenuCatalogButtonStyle;
}

export const TIEREDMENU_CATALOG_VARIANT_OPTIONS: {
  label: string;
  value: TieredMenuCatalogVariant;
}[] = [
  { label: 'Basic', value: 'basic' },
  { label: 'Popup', value: 'popup' },
];

export const TIEREDMENU_CATALOG_BUTTON_STYLE_OPTIONS: {
  label: string;
  value: TieredMenuCatalogButtonStyle;
}[] = [
  { label: 'Button default', value: 'button-default' },
  { label: 'Menu button', value: 'menu-button' },
];

export const TIEREDMENU_CATALOG_POPUP_TRIGGER_LABEL = 'Toggle';
export const TIEREDMENU_CATALOG_POPUP_TRIGGER_ICON = 'pi pi-bars';
export const TIEREDMENU_CATALOG_MENU_BUTTON_ICON = 'pi pi-bars';

export function buildTieredMenuCatalogModel(): MenuItem[] {
  return [
    {
      label: 'File',
      icon: 'pi pi-file',
